...
- [cowboysysop/charts](https://github.com/cowboysysop/charts) ([whoami-4.3.0](https://github.com/cowboysysop/charts/releases/tag/whoami-4.3.0), 1 day ago) - Cowboy Sysop Charts
- [go-skynet/LocalAI](https://github.com/go-skynet/LocalAI) ([v1.22.0](https://github.com/go-skynet/LocalAI/releases/tag/v1.22.0), 3 days ago) - :robot: Self-hosted, community-driven, local OpenAI-compatible API. Drop-in replacement for OpenAI running LLMs on consumer-grade hardware. Free Open Source OpenAI alternative. No GPU required. LocalAI is an API to run ggml compatible models: llama, gpt4all, rwkv, whisper, vicuna, koala, gpt4all-j, cerebras, falcon, dolly, starcoder, and many other
...
- [feat!: update helm release mariadb to v12](https://github.com/sebastien-prudhomme/cowboysysop-charts-test/pull/98) on [sebastien-prudhomme/cowboysysop-charts-test](https://github.com/sebastien-prudhomme/cowboysysop-charts-test) (2 days ago)
...
- [jouve/charts](https://github.com/jouve/charts) -  (6 days ago)
