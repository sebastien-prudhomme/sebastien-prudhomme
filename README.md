...
- [ci: update actions/setup-python action to v4.6.1](https://github.com/cowboysysop/docker-pytest/pull/330) on [cowboysysop/docker-pytest](https://github.com/cowboysysop/docker-pytest) (3 days ago)
