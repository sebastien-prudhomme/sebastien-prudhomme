...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ([v0.36.0-nightly.20260318.e2658ccda](https://github.com/google-gemini/gemini-cli/releases/tag/v0.36.0-nightly.20260318.e2658ccda), today) - An open-source AI agent that brings the power of Gemini directly into your terminal.
...
- [feat!: update quay.io/go-skynet/local-ai docker tag to v4](https://github.com/sebastien-prudhomme/cowboysysop-charts-test/pull/45) on [sebastien-prudhomme/cowboysysop-charts-test](https://github.com/sebastien-prudhomme/cowboysysop-charts-test) (3 days ago)
...
- [qjoly/talosctl-oidc](https://github.com/qjoly/talosctl-oidc) - OIDC certificate exchange server and client for Talos Linux. Enables OIDC-based access control for talosctl by issuing ephemeral short-lived client certificates signed by the Talos CA. (4 weeks ago)
