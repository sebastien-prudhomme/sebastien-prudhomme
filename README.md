...
- [go-skynet/LocalAI](https://github.com/go-skynet/LocalAI) ([v1.17.0](https://github.com/go-skynet/LocalAI/releases/tag/v1.17.0), 1 day ago) - :robot: Self-hosted, community-driven, local OpenAI-compatible API. Drop-in replacement for OpenAI running LLMs on consumer-grade hardware. No GPU required. LocalAI is a RESTful API to run ggml compatible models: llama.cpp, alpaca.cpp, gpt4all.cpp, rwkv.cpp, whisper.cpp, vicuna, koala, gpt4all-j, cerebras and many others!
