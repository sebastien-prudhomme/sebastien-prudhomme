...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ([v0.43.0](https://github.com/google-gemini/gemini-cli/releases/tag/v0.43.0), 1 day ago) - An open-source AI agent that brings the power of Gemini directly into your terminal.
...
- [rash-sh/rash](https://github.com/rash-sh/rash) - Declarative shell scripting using Rust native bindings inspired by Ansible (2 days ago)
