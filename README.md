...
- [DefectDojo/django-DefectDojo](https://github.com/DefectDojo/django-DefectDojo) ([2.30.2](https://github.com/DefectDojo/django-DefectDojo/releases/tag/2.30.2), 3 days ago) -  DevSecOps, ASPM, Vulnerability Management. All on one platform.
...
- [TencentARC/PhotoMaker](https://github.com/TencentARC/PhotoMaker) - PhotoMaker (1 day ago)
- [zifeo/terraform-openstack-rke2](https://github.com/zifeo/terraform-openstack-rke2) - Easily deploy a high-availability RKE2 Kubernetes cluster on OpenStack providers like Infomaniak. (4 days ago)
