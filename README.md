...
- [DefectDojo/django-DefectDojo](https://github.com/DefectDojo/django-DefectDojo) ([2.38.3](https://github.com/DefectDojo/django-DefectDojo/releases/tag/2.38.3), 3 days ago) -  DevSecOps, ASPM, Vulnerability Management. All on one platform.
- [cowboysysop/docker-pytest](https://github.com/cowboysysop/docker-pytest) ([v1.0.45](https://github.com/cowboysysop/docker-pytest/releases/tag/v1.0.45), 4 days ago) - Docker Image for Pytest
- [cowboysysop/charts](https://github.com/cowboysysop/charts) ([ollama-1.3.5](https://github.com/cowboysysop/charts/releases/tag/ollama-1.3.5), 4 days ago) - Cowboy Sysop Charts

#### 🔨 My recent Pull Requests

- [ci: update dependency node to v22.9.0](https://github.com/cowboysysop/docker-pytest/pull/411) on [cowboysysop/docker-pytest](https://github.com/cowboysysop/docker-pytest) (4 days ago)
- [ci: update actions/setup-node action to v4.0.4](https://github.com/cowboysysop/docker-pytest/pull/410) on [cowboysysop/docker-pytest](https://github.com/cowboysysop/docker-pytest) (4 days ago)
- [feat: update docker.io/flowiseai/flowise docker tag to v2.1.1](https://github.com/cowboysysop/charts/pull/735) on [cowboysysop/charts](https://github.com/cowboysysop/charts) (4 days ago)
- [fix: update docker.io/ollama/ollama docker tag to v0.3.11](https://github.com/cowboysysop/charts/pull/734) on [cowboysysop/charts](https://github.com/cowboysysop/charts) (4 days ago)
- [ci: update renovatebot/github-action action to v40.2.10](https://github.com/cowboysysop/charts/pull/733) on [cowboysysop/charts](https://github.com/cowboysysop/charts) (4 days ago)
...
- [YounitedCredit/younited-genaibots](https://github.com/YounitedCredit/younited-genaibots) - GenaiBots is an open-source framework that simplifies building intelligent and adaptable conversational agents using generative AI and a powerful plugin system. (1 day ago)
- [secureCodeBox/secureCodeBox](https://github.com/secureCodeBox/secureCodeBox) - secureCodeBox (SCB) - continuous secure delivery out of the box  (3 days ago)
