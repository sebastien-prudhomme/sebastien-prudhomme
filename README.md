...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ([v0.45.0-nightly.20260528.g5cac7c10f](https://github.com/google-gemini/gemini-cli/releases/tag/v0.45.0-nightly.20260528.g5cac7c10f), today) - An open-source AI agent that brings the power of Gemini directly into your terminal.
...
- [borgbase/vykar](https://github.com/borgbase/vykar) - Fast, encrypted, deduplicated backups in Rust — with friendly YAML config, a desktop GUI, and support for S3, custom REST and SFTP storage. (3 weeks ago)
- [Yeachan-Heo/oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) - OmX - Oh My codeX: Your codex is not alone. Add hooks, agent teams, HUDs, and so much more. (4 weeks ago)
